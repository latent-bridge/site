    ...
    >
      ...
      <section className="mt-16 rounded-3xl bg-warm-bg/40 p-8">
        ...
        <div className="mt-5 space-y-4 text-sm leading-loose">
          ...
          <p>
            ファンサイト経由なら、こうした手数料はかからず、
            切り抜き制作やサイト構築のサポート費用を差し引いても、
            配信者の手取りが増えるような設計になっています。
          </p>
          <p>
            <span className="font-bold">場所を作る</span>
            ：配信プラットフォームとは別に、配信者それぞれが
            自分のスタイルで視聴者と向き合える場所を、一人ずつ組み上げます。
            動画の蓄積の見せ方、視聴者との接し方、世界観の表し方まで、
            配信者ごとに作りを変える前提です。
          </p>
        </div>
      </section>
