  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <header className="mt-6">
        <p className="text-xs tracking-wide text-accent mb-3">Sites</p>
        <h1 className="text-2xl sm:text-3xl font-bold">公開物リンク</h1>
        <p className="mt-6 text-sm leading-loose">
          このケースで公開・運用している全ての成果物の入口です。
          <br />
          ファンサイト本体、配信者向け管理画面、世界観を支える素材まで。
        </p>
      </header>
              ...
              <li key={link.slug}>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-4 text-[11px] text-accent group-hover:underline break-all">
                      {link.url} ↗
                    </p>
                  </div>
                </a>
